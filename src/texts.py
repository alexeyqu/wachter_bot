...
По умолчанию за 10 минут до удаления я отправляю сообщение с напоминанием.""",
    ...
    "msg__set_new_welcome_message": "Отправьте новый текст сообщения при входе в чат. Используйте `%USER\\_MENTION%`, чтобы тегнуть адресата.",
    "msg__set_new_kick_timout": "Отправьте новое время до удаления в минутах",
    "msg__set_new_rewelcome_message": "Отправьте новый текст сообщения при перезаходе в чат. Используйте `%USER\\_MENTION%`, чтобы тегнуть адресата.",
    "msg__set_new_notify_message": "Отправьте новый текст сообщения напоминания. Используйте `%USER\\_MENTION%`, чтобы тегнуть адресата.",
    "msg__set_new_sucess_message": "Отправьте новый текст сообщения после представления. Используйте `%USER\\_MENTION%`, чтобы тегнуть адресата.",
    "msg__set_new_whois_length": "Отправьте новую необходимую длину #whois (количество символов).",
    "msg__set_new_kick_message": "Отправьте новый текст сообщения после удаления. Используйте `%USER\\_MENTION%`, чтобы тегнуть адресата.",
    "msg__set_new_notify_timeout": "Отправьте новое время до напоминания в минутах.",
    "msg__set_new_whois_message": "Отправьте новый текст сообщения для обновления #whois (должно содержать хэштег #update). Используйте `%USER\\_MENTION%`, чтобы тегнуть адресата.",
