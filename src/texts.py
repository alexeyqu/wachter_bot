...
По умолчанию за 10 минут до удаления я отправляю сообщение с напоминанием.""",
    ...
    "msg__introduce_message_updat": "Если вы хотите обновить, то добавьте тег #update к сообщению",
    "msg__new_chat_membeSr": "Добро пожаловать! Пожалуйста, представьтесь с использованием хэштега #whois и поздоровайтесь с сообществом.",
